...
* [GraphandModel](GraphandModel.md#GraphandModel)
    ...
    * _static_
        ...
        * [.Scopes](#GraphandModel.Scopes) : [<code>ModelScopes</code>](typedef.md#ModelScopes)
...
### graphandModel.assign(values, [upsert])
...
### GraphandModel.Scopes : [<code>ModelScopes</code>](typedef.md#ModelScopes)
**Kind**: static property of [<code>GraphandModel</code>](GraphandModel.md#GraphandModel)  
...
| Param | Type | Description |
| --- | --- | --- |
| query | <code>string</code> \| [<code>Query</code>](typedef.md#Query) | the requested _id or the request query (see api doc) |
| opts |  |  |
...
| handler | [<code>GraphandModelHookHandler</code>](typedef.md#GraphandModelHookHandler) | The handler that will be executed |
| options |  |  |
...
| Param | Type | Description |
| --- | --- | --- |
| query | [<code>Query</code>](typedef.md#Query) | the request query (see api doc) |
| opts |  |  |
...
| Param | Type | Description |
| --- | --- | --- |
| update | [<code>Update</code>](typedef.md#Update) | query and payload to apply |
| [options] |  |  |
...
| Param | Type | Description |
| --- | --- | --- |
| del | [<code>GraphandModel</code>](GraphandModel.md#GraphandModel) \| [<code>Query</code>](typedef.md#Query) | query of target instances to delete (ex: { query: { ... } }) |
| [options] |  |  |
